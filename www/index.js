...
const acceptButton = document.getElementById("accept-check");
const declineButton = document.getElementById("decline-check");
...
socket.on("GameflowPhase", phase => {
    console.log(phase);


    gameflow.innerHTML = phase;
    buttonsDiv.hidden = true;

    if(phase === PHASES.READYCHECK) {
        navigator.vibrate(200)
        hasClicked = false;
        buttonsDiv.hidden = false;
        buttonsDiv.classList.remove("gray")
...
acceptButton.onclick = () => {
    ...
    buttonsDiv.classList.add("gray");
    hasClicked = true;

    acceptButton.disabled = true;
    declineButton.disabled = true;

    socket.emit("accept-check");
}
